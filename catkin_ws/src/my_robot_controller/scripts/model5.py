...
def feature_ext():
        ...
        g = Dense(32,activation = 'linear')(g)
        ...
        features = Flatten()(baseModel.output)
...
def Actor(state_Dims):
    features = layers.Input(shape=(25088,))
    
    linear_vel = layers.Dense(4096, activation="relu" , name = 'first_lin')(features)
    linear_vel = layers.Dense(1024, activation="relu")(linear_vel)
    linear_vel = layers.Dense(512, activation="relu")(linear_vel)
    linear_vel = layers.Dense(256, activation="relu")(linear_vel)
    linear_vel = layers.Dense(64, activation="relu")(linear_vel)
    linear_vel = layers.Dense(16, activation="relu")(linear_vel)
    linear_vel = layers.Dense(1,)(linear_vel)                        
    linear_net =Activation("linear", name="linear_output")(linear_vel)                  
     
     
                                                                                         
    angular_vel = layers.Dense(4096, activation="relu",name = 'first_ang')(features)
    angular_vel = layers.Dense(1024, activation="relu")(angular_vel)
    angular_vel = layers.Dense(512, activation="relu")(angular_vel)
    angular_vel = layers.Dense(256, activation="relu")(angular_vel)
    angular_vel = layers.Dense(64, activation="relu")(angular_vel)
...
def value_net(state_dim,Neurons=25088):
...
def target_value_net(state_dim,Neurons=25088):
...
def trainable_reward_func(in_Dims):
    ...
    linear_vel = Dense(256, activation="relu")(linear_vel)
    linear_vel = Dense(64, activation="relu")(linear_vel)
    linear_vel = Dense(16, activation="relu")(linear_vel)
    ...
    angular_vel = Dense(256, activation="relu")(angular_vel)
    angular_vel = Dense(64, activation="relu")(angular_vel)
    angular_vel = Dense(16, activation="relu")(angular_vel)
