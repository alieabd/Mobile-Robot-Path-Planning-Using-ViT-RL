...
class SoftActorCritic:
    ...
    def update_D_Qn(self,n_state,action,Lim,G_reward,C_reward,traj_reward,state):
    ...
    def update_value_net(self,st,act,batch_size):
            ...
            act_th = tf.math.log(abs(act_th) + 0.00001)
            act_vel = tf.math.log(abs(act_vel) + 0.00001)
...
def train(memory):
    ...
    sac.update_D_Qn(pro_n_state,act,Lim,G_reward,C_reward,traj_reward,pro_state)
